...
async function canMsgSend(id,size,canInfo){
  ...
  switch(size){
    ...
    case 32:
      ...
      return 0;
    case 64:
      canMsgSend.data = Buffer.from([canInfo[0],canInfo[0]>>8,canInfo[0]>>16,canInfo[0]>>24,BigInt(canInfo[0])>>32,BigInt(canInfo[0])>>40,BigInt(canInfo[0])>>48,BigInt(canInfo[0])>>56]);
      console.log("here4");
      channel.send(canMsgSend);
      return 0;
    default:
